package com.cpiaoju.cslmback.common.authentication.jwt;
...
import com.cpiaoju.cslmback.common.util.SpringContextUtil;
...
public class JWTFilter extends BasicHttpAuthenticationFilter {
    ...
    protected boolean sendChallenge(ServletRequest request, ServletResponse response) {
        ...
        try (PrintWriter out = httpResponse.getWriter()) {
            CslmResponse tandemResponse = new CslmResponse().message(message).code(HttpStatus.UNAUTHORIZED);
            String json = JSONUtil.toJsonStr(tandemResponse);
            log.info(json);
            out.print(json);
        } catch (IOException e) {
